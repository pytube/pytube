...
def cipher_signature():
    ...
    filename = 'yt-video-9bZkp7q19f0-1542554369.json.tar.gz'
...
def presigned_video():
    ...
    filename = 'yt-video-QRS8MkLhQmM-1542554372.json.tar.gz'
    return load_and_init_from_playback_file(filename)
...
def age_restricted():
    ...
    filename = 'yt-video-zRbsm3e2ltw-1542554374.json.tar.gz'
