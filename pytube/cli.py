...
def download_caption(
    ...
    caption = youtube.captions.get_by_language_code(lang_code=lang_code)#!/usr/bin/env python3
"""A simple command line application to download youtube videos."""
...
def download_audio(
    ...
    """
    audio = (
        youtube.streams.f#!/usr/bin/env python3
"""A simple command line application to download youtube videos."""
...
def download_audio(
    ...
    """
    audio = (
        youtube.streams.fi#!/usr/bin/env python3
"""A simple command line application to download youtube videos."""
...
if __name__ == "__main__":
    main()
lter(only_audio=True, subtype=filetype)
        .order_by("abr")
        .desc()
        .first()
    )
...
if __name__ == "__main__":
    main()
ilter(only_audio=True, subtype=filetype)
        .order_by("abr")
        .desc()
        .first()
    )
